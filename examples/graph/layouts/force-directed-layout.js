  ...
  this.generate = function() {
    if(layout_iterations < this.max_iterations && temperature > 0.000001) {
      ...
      for(var i=0; i < nodes_length; i++) {
        ...
        layout_v.tmp_pos_x = layout_v.tmp_pos_x || node_v.position.x;
        layout_v.tmp_pos_y = layout_v.tmp_pos_y || node_v.position.y; 
        layout_v.tmp_pos_z = layout_v.tmp_pos_z || node_v.position.z;
        ...
        for(var j=i+1; j < nodes_length; j++) {
          ...
          if(i != j) {
            ...
            var layout_u = node_u.layout;

            layout_u.tmp_pos_x = layout_u.tmp_pos_x || node_u.position.x;
            layout_u.tmp_pos_y = layout_u.tmp_pos_y || node_u.position.y;
            layout_u.tmp_pos_z = layout_u.tmp_pos_z || node_u.position.z;
            

            var delta_x = layout_v.tmp_pos_x - layout_u.tmp_pos_x;
            ...
            layout_v.force += force;
            layout_u.force += force;

            layout_v.offset_x += (delta_x / delta_length) * force;
            layout_v.offset_y += (delta_y / delta_length) * force;
            ...
            layout_u.offset_x -= (delta_x / delta_length) * force;
            layout_u.offset_y -= (delta_y / delta_length) * force;
